...
export const metadata: Metadata = {
  ...
  description: "PEPEPOW Auto Battleground v0.9.2 — 33 original units, 14 illustrated synergies, clearer combat feedback, deterministic replays, and adaptive AI commanders.",
  other: {
