...
export const TRAIT_DETAILS: Record<Trait, TraitDetail> = {
  ...
  Guardian: { category: "Class", thresholds: [2, 4], summary: "Guardians form an armored front line.", tiers: ["Guardians gain +18 Armor.", "Guardians gain +34 Armor."], appliesTo: "Trait units" },
